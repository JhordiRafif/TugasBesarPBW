...
<div class="topnav">
            ...
            <a href="soldpets.php">Peliharaan terjual</a>
...
<button   style=" height: 50px;width: 150px;cursor:pointer;border-radius:15px;
border: 3px solid #e69500;background-color: rgba(249, 105, 14, 1);color:#f2f2f2;font-size:15px;" formaction="soldptadd.php">Tambahkan detail</button>
</form>
</div>
...
<input  type="text" name="t1" placeholder="Masukkan ID sales" required>
<input   type="text" name="t2" placeholder="Masukkan ID hewan" required>
