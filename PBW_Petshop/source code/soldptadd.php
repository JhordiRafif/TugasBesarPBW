...
<form>
    ...
    border-radius:15px;
border: 3px solid #e69500;background-color: rgba(249, 105, 14, 1);color:#f2f2f2;font-size:15px;cursor:pointer;">Kembali</button>
</form>  
<form method="post" action="soldptadd.php"> 
<fieldset> 
   <input type="text" name="id" placeholder="Masukkan ID sales" style="width:100%;height:30px;
    border: 2px solid rgba(249, 105, 14, 1); border-radius:5px;  background:transparent;" required>
  <br><br>
   <input type="text" name="pp" placeholder="Masukkan ID hewan" style="width:100%;height:30px;
    border: 2px solid rgba(249, 105, 14, 1); border-radius:5px;  background:transparent;" required>
  <br><br>
