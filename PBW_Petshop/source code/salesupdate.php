...
<body>
  <div class="topnav">
    ...
    <a href="sales.php">Update penjualan</a>
...
border: 3px solid #e69500;background-color: rgba(249, 105, 14, 1);color:#f2f2f2;font-size:15px;">Kembali</button>
  </form>
  <form method="post" action="salesupdate.php">

    <fieldset>

      <input type="text" id="sd" name="id" placeholder="Masukkan ID Penjual" style="width:100%;height:30px;
    border: 2px solid rgba(249, 105, 14, 1); border-radius:5px;" required>
      <br><br>
      <input type="text" name="csid" placeholder="Masukkan ID Pelanggan" style="width:100%;height:30px;
    border: 2px solid rgba(249, 105, 14, 1);border-radius:5px; " required>
      <br><br>
   ...
   border: 2px solid rgba(249, 105, 14, 1);border-radius:5px;" required placeholder="Jumlah Total">
      <br><br>
