...
<body>
  <div class="topnav">
    ...
    <a href="soldproducts.php">Produk Terjual</a>
...
border: 3px solid #e69500;background-color: rgba(249, 105, 14, 1);color:#f2f2f2;font-size:15px;" formaction="sales.php">Kembali</button>
      <button style=" height: 50px;width: 150px;cursor:pointer;border-radius:15px;
border: 3px solid #e69500;background-color: rgba(249, 105, 14, 1);color:#f2f2f2;font-size:15px;" formaction="soldpdadd.php">Tambah Data baru</button>
    </form>
  </div>
  ...
  <form action="deletesoldpd.php" method="post">
    <input type="text" name="t1" placeholder="Masukkan ID Penjual" required>
    <input type="text" name="t2" placeholder="Masukkan ID barang" required>
