...
<div class="topnav">
            ...
            <a href="phone.php">Nomor Pelanggan</a>
...
border: 3px solid  #b40a70;background-color: #8d2663;color:#f2f2f2;font-size:15px;" formaction="customer.php">Kembali</button>
<button   style=" height: 50px;width: 150px;cursor:pointer;border-radius:15px;
border: 3px solid  #b40a70;background-color: #8d2663;color:#f2f2f2;font-size:15px;"formaction="phoneadd.php">Tambah nomor</button>
</form>
</div>
    <?php
...
<input  type="text" name="t1" placeholder="Masukkan ID" required>
<input   type="number" name="t2" placeholder="Masukkan nomor" required>
