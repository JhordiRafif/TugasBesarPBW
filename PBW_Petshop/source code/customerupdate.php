...
<div class="topnav">
   ...
   <form>
       ...
       border-radius:15px;
border: 3px solid  #b40a70;background-color: #8d2663;color:#f2f2f2;font-size:15px;cursor:pointer;">Kembali</button>
</form> 
<form method="post" action="customerupdate.php">  
<fieldset> 
   <input type="text" name="id" placeholder="Masukkan ID pelanggan ..." style="width:100%;height:30px;
    border: 2px solid  #b40a70; border-radius:5px; background:transparent;" required>
  <br><br>
 <input type="text" name="fname" placeholder="Nama awal pelanggan ..." style="width:100%;height:30px;
    border: 2px solid #b40a70; border-radius:5px; background:transparent;" required>
  <br><br>
   <input type="text" name="minit" placeholder="Nama panggilan pelanggan ..." style="width:100%;height:30px;
    border: 2px solid  #b40a70; border-radius:5px; background:transparent;" required>
  <br><br>
   <input type="text" name="lname" placeholder="Nama akhir pelanggan" style="width:100%;height:30px;
    border: 2px solid  #b40a70; border-radius:5px; background:transparent;" required>
  <br><br>
  <input type="text" name="address" placeholder="Masukkan Alamat ..." style="width:100%;height:30px;
    border: 2px solid  #b40a70; border-radius:5px; background:transparent;" required>
  <br><br>
...
$id = $_POST["id"];
  ...
  if ($conn->query($sql) == TRUE) {
    ...
    echo '<div>
    <h1 style="color:#f2f2f2;font-size:30px; font-family: "Roboto", sans-serif;margin:auto;">ID tidak ditemukan</h1>
       </div>';
}
